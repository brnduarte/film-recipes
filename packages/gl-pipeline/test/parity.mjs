...
const RECIPES = {
  ...
  "kodak-portra-400": {
    ...
    white_balance: { kelvin: 5500, red_shift: 2, blue_shift: -4 },
    exposure_compensation: 0.0,
  },
  "kodak-gold-200": {
    film_simulation: "ClassicChrome",
  ...
  "bright-kodak": {
    ...
    color_chrome_effect: "Off",
    color_chrome_fx_blue: "Off",
    white_balance: { kelvin: 5500, red_shift: 3, blue_shift: -7 },
    exposure_compensation: 0.0,
  },
  "grainy-day": {
    film_simulation: "ClassicNeg",
    ...
    color_chrome_effect: "Off",
    color_chrome_fx_blue: "Weak",
    white_balance: { kelvin: 5500, red_shift: 4, blue_shift: -4 },
    exposure_compensation: 0.0,
  },
  "wes-anderson": {
    film_simulation: "ClassicChrome",
    ...
    color_chrome_effect: "Off",
    color_chrome_fx_blue: "Weak",
    white_balance: { kelvin: 4350, red_shift: 6, blue_shift: -8 },
    exposure_compensation: 0.0,
  },
};
...
let total = 0;
let failures = 0;
for (const { name, pixels } of golden) {
  ...
  for (const { input, expected } of pixels) {
    total++;
    const actual = recipeReference(input, recipe, 0);
